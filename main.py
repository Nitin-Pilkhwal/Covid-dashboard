...
fig = px.scatter(df,x="gdpPercap",y="lifeExp",size="pop", color="continent",hover_name="continent",log_x=True, size_max=55, range_x=[100,100000],range_y=[25,90], animation_frame='year',animation_group='country')
...
covid.columns = ['Country','Date','Confirmed','Days since confirmed']
...
fig2.layout.updatemenus[0].button[0].arg[1]['frame']['duration'] = 30
fig2.layout.updatemenus[0].button[0].arg[1]['transition']['duration'] = 5
